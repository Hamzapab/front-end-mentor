...
export function Home() {
  ...
  return (
    <>
      ...
      <Navbar />
      {/* Hero Section */}
      <header className="hero bg-white py-10 pb-40" role="banner">
        <div className="mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="text-center md:text-start p-6 md:px-20 md:flex-1">
            ...
            <Button
              ...
              asChild
            >
              <a href="#shorten" aria-label="Get Started with URL shortening">
                Get Started
              </a>
            </Button>
          </div>
      ...
      <main id="shorten" className="shorten -mt-20 p-6 py-8 md:px-20" role="main">
        <section className="container relative bg-[#3b3054] p-6 py-8 md:p-12 rounded-lg" aria-labelledby="shorten-link-form">
          ...
          <form
            ...
            className="relative z-1 flex flex-col md:flex-row items-center md:items-start gap-3.5 md:gap-10"
            aria-labelledby="shorten-link-form"
          >
            ...
            >
              {isLoading ? (
                <Loader2 className="animate-spin mr-2 h-5 w-5" aria-label="Loading" />
              ) : (
                "Shorten It!"
              )}
            </Button>
          ...
          <div className="container mx-auto">
            {shortUrls.map((link, idx) => (
              <div key={idx} className="bg-white rounded-lg py-5 mb-5" role="region" aria-label={`Shortened URL ${idx + 1}`}>
                <p className="text-[#35323e] font-medium pb-3 px-4 w-full border-b border-b-[#bfbfbf] break-all">
                ...
                <div className="px-4 md:flex justify-between items-center ">
                  ...
                  <Button
                    ...
                    aria-label={copiedUrl === link.short ? "URL copied to clipboard" : "Copy shortened URL"}
                  >
      ...
      <Statis />
      {/* Boost */}
      <section className="relative bg-[#3b3054] py-42 md:py-20 z-1" aria-label="Boost your links">
        <div
